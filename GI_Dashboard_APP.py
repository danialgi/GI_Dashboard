...
st.title("✍ Receiving")
df1s = df1.groupby('user_name').sum()
...
df2s = df2.groupby('user_name').sum()
...
df3s = df3.groupby('user_name').sum()
...
df4s = df4.groupby('user_name').sum()
...
df5s = df5.groupby('user_name').sum()
...
st.title("🚛 Loading")
df6s = df6.groupby('user_name').sum()
